                            ...
                            <Row>
                                <Col lg={4}>
                                    <Form.Group>
                                        ...
                                        <Form.Control type="text" name="nama-pemesan" placeholder="cth. Ahmad Fulan" />
                                    </Form.Group>
                                </Col>
                            ...
                            <Row>
                                <Col lg={4}>
                                    <Form.Group>
                                        ...
                                        <Form.Control type="text" name="perusahaan" placeholder="cth. PT.ABC" />
                                    </Form.Group>
                                </Col>
                                ...
                                <Col lg={4}>
                                    <Form.Group>
                                        ...
                                        <Form.Control type="Number" name="jumlah-orang" min={2} value={jumlah} onChange={handleJumlahChange} max={10} />
                                    </Form.Group>
                                </Col>
                            </Row>
                        </div>
